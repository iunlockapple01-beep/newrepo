  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <main className="max-w-3xl mx-auto pt-24 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 mb-8"><Link href="/my-account"><Button variant="outline" size="icon"><ArrowLeft className="h-4 w-4" /></Button></Link><h1 className="text-3xl font-bold">Submit Support Ticket</h1></div>
        <Card>
          <CardHeader><CardTitle className="flex items-center gap-2"><MessageSquare className="text-blue-600 h-5 w-5" />How can we help?</CardTitle></CardHeader>
          <CardContent>
          ...
          <CardFooter className="bg-gray-50 border-t p-4"><p className="text-xs text-gray-500 text-center w-full">Responds within 1-24 hours.</p></CardFooter>
        </Card>
      </main>
    </div>
  );
