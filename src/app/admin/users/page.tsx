  ...
  return (
    <div className="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
      ...
      <main className="flex-grow max-w-7xl mx-auto pt-24 pb-12 px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center gap-4 mb-10"><Link href="/admin"><Button variant="outline" size="icon"><ArrowLeft /></Button></Link><h1 className="text-4xl font-bold">User Management</h1></div>
